...
[Z] [M] [P]
 1   2   3 `;
const test2 = `move 1 from 2 to 1
move 3 from 1 to 3
move 2 from 2 to 1
move 1 from 1 to 2`;

console.log("sol1: ", solution1(arr, instructions));
console.log("sol2: ", solution2(arr, instructions));

function solution1(arr, instructions) {
